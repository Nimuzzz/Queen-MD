...
reply(`
කරුණාකර ඔහුව ටැග් කිරීමට උත්සාහ නොකරන්න!
ඔහු offline ${user.afkReason ? ' after ' + user.afkReason : ''}
...
let cron = require('node-cron')
    ...
    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
      ...
      await Queen.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `🎮 Guess The Song 🎮\n\nනිවැරදි පිළිතුර 🎉\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
      ...
      if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
        ...
        if (budy.toLowerCase() == jawaban) {
        await Queen.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `🎮 Guess The Picture 🎮\n\nනිවැරදි පිළිතුර 🎉\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
          ...
          if (budy.toLowerCase() == jawaban) {
          await Queen.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `🎮 Guess The Word 🎮\n\nනිවැරදි පිළිතුර 🎉\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
          ...
          if (budy.toLowerCase() == jawaban) {
          await Queen.sendButtonText(m.chat, [{ buttonId: 'guess saying', buttonText: { displayText: 'Guess The Saying' }, type: 1 }], `🎮 Guess The Saying 🎮\n\nනිවැරදි පිළිතුර 🎉\n*${deskripsi}*\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
          ...
          if (budy.toLowerCase() == jawaban) {
          await Queen.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess The Sentence' }, type: 1 }], `🎮 Guess The Sentence 🎮\n\nනිවැරදි පිළිතුර 🎉\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
          ...
          if (budy.toLowerCase() == jawaban) {
          await Queen.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `🎮 Guess The Lyrics 🎮\n\nනිවැරදි පිළිතුර 🎉\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
          ...
          if (budy.toLowerCase() == jawaban) {
          await Queen.sendButtonText(m.chat, [{ buttonId: 'riddles', buttonText: { displayText: 'Riddles' }, type: 1 }], `🎮 Riddles 🎮\n\nනිවැරදි පිළිතුර 🎉\n\nනැවත ක්‍රීඩා කිරීමට අවශ්‍යද? පහත බොත්තම ඔබන්න`, `${global.BotName}`, m)
          ...
          Queen.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} rejected the suit, the suit is canceled`, m)
          ...
          Queen.sendText(m.chat, `Suit has been sent to chat
          @${roof.p.split`@`[0]} dan 
          @${roof.p2.split`@`[0]}

          Please choose a suit in the respective chat"
          Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
          if (!roof.pilih) Queen.sendText(roof.p, `Please select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
          if (!roof.pilih2) Queen.sendText(roof.p2, `Please select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
          roof.waktu_milih = setTimeout(() => {
          if (!roof.pilih && !roof.pilih2) Queen.sendText(m.chat, `Both players don't want to play,\nSuit canceled`)
          else if (!roof.pilih || !roof.pilih2) {
          win = !roof.pilih ? roof.p2 : roof.p
          Queen.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} don't choose suit, game over`, m)
          }
          delete this.suit[roof.id]
          return !0
          }, roof.timeout)
          ...
          if (!roof.pilih2) Queen.sendText(roof.p2, '_The opponent has chosen_\nNow it is your turn', 0)
          }
          if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
          roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
          roof.text2 = m.text
          reply(`You have chosen ${m.text} ${!roof.pilih ? `\n\nWaiting for the opponent to choose` : ''}`)
          if (!roof.pilih) Queen.sendText(roof.p, '_The opponent has chosen_\nNow it is your turn', 0)
          }
          ...
          if (roof.pilih && roof.pilih2) {
            ...
            Queen.sendText(roof.asal, `_*Suit Results*_${tie ? '\nSERIES' : ''}
...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: DarkWinzo to take your WhatsApp usage into next level.
...
if (!text) return reply(`Example : ${prefix + command} https://youtu.be/0VVfDGdDJ0o 128kbps`)
...
if (!text) return reply(`Example : ${prefix + command} https://youtu.be/0VVfDGdDJ0o 360p`)
if (!isUrl(args[0]) && !args[0].includes('youtube.com')) return reply(`ඔබ ලබා දුන් සබැඳිය වලංගු නැත!`)
...
case 'handsomecheck':
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
				if (!text) return replay(`Tag Someone, Example : ${prefix + command} @DarkWinzo`)
